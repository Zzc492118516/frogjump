...
var GameScene = (function (_super) {
    ...
    GameScene.prototype.onKeyUp = function () {
        ...
        egret.Tween.get(this.player).to({ rotation: this.direction > 0 ? -60 : 60 }, 250).call(function () {
        }).call(function () {
            egret.Tween.get(_this.player).to({ rotation: _this.direction > 0 ? 60 : -60 }, 200).call(function () {
            }).call(function () {
                egret.Tween.get(_this.player).to({ rotation: 0 }, 50).call(function () {
